  ...
  <div class="condition-list">
    <div v-for="condition in conditions" :key="condition.id">
      <div class="condition-list__item">
        <h5 class="condition-list__header">
          {{ condition.common_name }}
        </h5>
        <div
          v-if="condition.probability > 0.2 && showExplainButton"
        ...
        <div
          v-if="
            condition.conflicting_evidence &&
              condition.conflicting_evidence.length > 0
          "
          class="explain__evidences"
        >
          <div class="explain__header">
        ...
        <div
          v-if="
            condition.unconfirmed_evidence &&
              condition.unconfirmed_evidence.length > 0
          "
          class="explain__evidences"
        >
          <div class="explain__header">
