<template>
  <Step :disable-next="disabled" @answerGroup="answerGroup">
    ...
    <div class="step__widen">
      <div
        v-if="shouldStop !== true && isLoading === false"
        class="step-diagnosis"
      >
        <QuestionSingle
        ...
        />
        <QuestionGroupSingle
          v-else-if="question.type === 'group_single'"
          :question="question"
          :selected="question.selected"
          @answer="answerGroup"
        />
        <QuestionGroupMultiple
          v-else-if="question.type === 'group_multiple'"
          :question="question"
          :selected="question.selected"
          @answer="answerGroup"
        />
      ...
      <div v-else-if="shouldStop === true" class="step__final">
        ...
        <ConditionList
          ...
          v-bind:show-explain-button="true"
        />
      </div>
